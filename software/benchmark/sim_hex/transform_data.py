...
# RV_ROOT="/home/damon_devil/RV32I_X"
assert RV_ROOT

programordata='data'

input_file=open(RV_ROOT + '/software/benchmark/sim_hex/' +programordata+'.hex')


output_file1=open(RV_ROOT + '/software/benchmark/sim_hex/'+programordata+'_dccm.hex','w')
    ...
    if line_list[0][0]=='@':
        ...
        if addr_local == addr + i :
            ...
            if (addr)==0:
                ...
                output_file1.write('\n')
            # elif (addr/4)%4==1:
            #     output_file2.write('@'+hex(addr/16)[2:].upper())
            #     output_file2.write('\n')
            #     output_file2.write(instr)
            #     output_file2.write('\n')
            # elif (addr/4)%4==2:
            #     output_file3.write('@'+hex(addr/16)[2:].upper())
            #     output_file3.write('\n')
            #     output_file3.write(instr)
            #     output_file3.write('\n')
            # elif (addr/4)%4==3:
            #     output_file4.write('@'+hex(addr/16)[2:].upper())
            #     output_file4.write('\n')
...
if i!=0:
    # if (addr/4)%4==0:
    output_file1.write('@'+hex(addr/16)[2:].upper())
    output_file1.write('\n')
    output_file1.write(instr)
    output_file1.write('\n')
    # elif (addr/4)%4==1:
